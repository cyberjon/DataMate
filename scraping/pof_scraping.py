...
def main():
    ...
    pof_online = 'https://www.pof.com/everyoneonline.aspx' # currently online url - page 1
    ...
    count = 0
    profile_urls = []     # create empty list to hold all profile urls to be scraped later
    page = 2

    # get at least 100 profile urls
    while count < 75:
